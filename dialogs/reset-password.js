...
library.dialog('/', [
    (session) => {
        session.beginDialog('validators:email', {
            ...
            retryPrompt: 'The value entered is not an email address. Please try again using the following format xyz@kpmg.co.ke',
            maxRetries: 2
        });
    },
    (session, args) => {
        ...
        session.send('The email you provided is: ' + args.response);
